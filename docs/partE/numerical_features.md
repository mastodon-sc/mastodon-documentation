...
| **Feature name**                 | **Projections** | **Description**                                                                                                                                                                                                                                                                                         |
|----------------------------------|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Branch N successors              | _idem_          | Reports the number of immediate successors of a branch spot. That is: how many branches emerge from this branch-spot. The branch-spot of a cell that divides will have a value of 2 for this feature. The end of a track will have a value of 0. The beginning of a track, 1.                           |
...
|                                  | Duration        | The time difference between the first and last spot of the branch. <br><br> Example visualization: ![branchDurationAnimation.gif](branchDurationAnimation.gif)                                                                                                                                          |
